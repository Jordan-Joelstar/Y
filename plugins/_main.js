...
smd({
  ...
  try {
    try {
      ...
      if (!_0x557719) {
        return man.reply("No query. Give me one  boss 👀");
      }
...
smd({
  ...
  try {
    ...
    let _0x1c73f9 = ("\n ,   ,    *" + Config.ownername + "*.\n\n  * :* " + (_0x44f98c?.stargazers_count || "120+") + " stars\n  * :* " + (_0x44f98c?.forks_count || "1000+") + " forks\n  * :* Jordan-Joelstar\n  *  :* " + (_0x44f98c?.created_at || "undefined") + "\n  * :* _https://github.com/jordan-joelstar/miles_\n  * :* _" + scan + "_" + (Config.caption ? "\n\n" + Config.caption : "")).trim();
