    ...
    async function _0x347a1f() {
      ...
      _0x1a9455.ev.on("messages.upsert", async _0x179239 => {
        ...
        try {
          ...
          const _0x6a8753 = ["@g.us", ...global.blockJids.split(",")];
        ...
        events.commands.map(async _0x51be89 => {
          if (_0x3f8405.status === "add" && _0x51be89.group === "add") {
            try {
              ...
              console.error("[GROUP PARTICEPANTS ADD ERROR] ", _0x169f0a);
            }
          }
          if (_0x3f8405.status === "remove" && _0x51be89.group === "remove") {
            try {
              ...
              console.error("[GROUP PARTICEPANTS REMOVE ERROR] ", _0x444bbc);
            }
          }
          if (_0x3f8405.status === "demote" && _0x51be89.group === "demote") {
            try {
              ...
              console.error("[GROUP PARTICEPANTS DEMOTE ERROR] ", _0x5516ae);
            }
          }
          if (_0x3f8405.status === "promote" && _0x51be89.group === "promote") {
            try {
              ...
              console.error("[GROUP PARTICEPANTS PROMOTE ERROR] ", _0x26f881);
            }
          }
          if (_0x51be89.group === "on" || _0x51be89.group === "group" || _0x51be89.group === "main" || _0x51be89.group === "all") {
            try {
              ...
              console.error("[GROUP PARTICEPANTS PROMOTE ERROR] ", _0x42582a);
            }
          }
        });
      });
          ...
          if (_0x3d78c6 === "open") {
            ...
            await _0x1a9455.sendMessage(_0x459047, {
              ...
              contextInfo: {
                externalAdReply: {
                  title: "Miles Sharing",
                  sourceUrl: "https://whatsapp.com/channel/0029VaCamn3BKfi29OjdbG2P"
                }
              }
            }, {
